...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference("Operation.count") do
      post operations_url, params: { operation: { kill_status: @operation.kill_status, status: @operation.status } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { kill_status: @operation.kill_status, status: @operation.status } }
